...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (lsp-ui lsp-java lsp-mode lsp-ivy projectile gdscript-mode color-theme-sanityinc-tomorrow cider clojure-mode counsel json-mode use-package-chords langtool swiper magit yasnippet web-mode move-text vertigo shell-pop restart-emacs dimmer pretty-mode expand-region multiple-cursors symon-mode diminish switch-window rainbow-mode company-mode smex beacon spacemacs-theme which-key use-package yaml-mode xah-fly-keys company omnisharp csharp-mode)))

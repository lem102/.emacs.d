...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((((type w32)) (:inherit nil :extend nil :stipple nil :background "#0d0e1c" :foreground "#ffffff" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight regular :height 113 :width normal :foundry "outline" :family "Consolas"))
            (((type x pgtk)) (:inherit nil :extend nil :stipple nil :background "#002451" :foreground "#ffffff" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight regular :height 113 :width normal :foundry "PfEd" :family "DejaVu Sans Mono")))))

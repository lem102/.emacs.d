...
(keymap-set jacob-modal-editing-keymap "w" #'jacob-shrink-whitespaces)
...
(keymap-set jacob-modal-editing-keymap "5" #'jacob-delete-forwards)
...
(keymap-set jacob-modal-editing-keymap "SPC i ," #'xah-open-in-external-app)
...
(keymap-set jacob-modal-editing-keymap "SPC i s" #'xah-show-in-desktop)

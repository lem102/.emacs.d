;;; jacob-editing-commands.el --- Editing commands  -*- lexical-binding: t; -*-
...
(defun jacob-join-line ()
  "Either delete blank lines, or join the line to the next one."
  (interactive)
  (if (looking-at-p "[ \t]*$")
      (delete-blank-lines)
    (delete-indentation)))

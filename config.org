...
** company
 #+BEGIN_SRC emacs-lisp
   (use-package company
     ...
     :defer t
     :diminish
     :hook ((emacs-lisp-mode-hook csharp-mode-hook java-mode-hook) . company-mode)
     :config
    ...
    (defun jacob-csharp-indent-or-complete ()
      ...
      (let ((old-point (point)))
        ...
        (if (eq old-point (point))
            (call-interactively 'omnisharp--popup-to-ido))))
...
#+BEGIN_SRC emacs-lisp
  (use-package yasnippet
    ...
    :hook
    (((csharp-mode-hook web-mode-hook python-mode-hook java-mode-hook) . yas-minor-mode))
      ...
      (if (and (minibufferp) (not (string= (minibuffer-prompt) "Eval: ")))
        ...
        (let* ((initial (buffer-substring-no-properties start end))
          ...
          (if (null completion)
            ...
            (insert completion)
            t))))
    ;; possibility that this is being set by bloody ivy!!!
